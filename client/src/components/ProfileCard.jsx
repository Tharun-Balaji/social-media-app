  ...
  return (
		<div>
			<div className="w-full bg-primary flex flex-col items-center shadow-sm rounded-xl px-6 py-4">
				...
				<div className="w-full flex flex-col gap-2 border-b border-[#66666645]">
					<div className="flex gap-2 items-center to-ascent-1">
						<CiLocationOn className="text-xl to-ascent-1" />
