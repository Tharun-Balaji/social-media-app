				...
				<div className="w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full">
					...
					<div className="flex-1 h-full bg-primary px-4 flex flex-col gap-6 overflow-y-auto rounded-lg">
						...
						>
							...
							<div className="flex items-center justify-between py-4">
								<label
									htmlFor="imgUpload"
									className="flex items-center gap-1 cursor-pointer text-base text-ascent-2 hover:to-ascent-1"
								>
									<input
										type="file"
										onChange={(e) =>
					...
					<div className="hidden w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto">
						...
						<div className="w-full bg-primary shadow-sm rounded-lg px-6 py-5">
							<div className="flex items-center justify-between text-xl to-ascent-1 pb2 border-b border-[#66666645]">
						...
						<div className="w-full bg-primary shadow-sm rounded-lg px-5 py-5">
							<div className="flex items-center justify-between text-xl to-ascent-1  border-b border-[#66666645]">
